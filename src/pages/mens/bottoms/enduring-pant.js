...
const MenEnduringPant = () => {
    ...
    const [imgSrc, setImgSrc] = useState('/men/bottoms/men_enduring_dark_min.jpg');
        ...
        if (e.target.value != colorSelected) {
            switch (e.target.value) {
                case 'dark':
                    ...
                    setImgSrc('/men/bottoms/men_enduring_dark_min.jpg');
                    break;
                case 'brown':
                    setColorSelected('brown');
                    setImgSrc('/men/bottoms/men_enduring_brown_min.jpg');
                    break;
                default:
                    break;
            }
        ...
        <div>
            <div className="product__row">
                ...
                <div className="product__text-area">
                    ...
                    to breathe — all while keeping the warmth in and the snow out. The Enduring Pant is fully waterproof and does not lose heat under compression. 
