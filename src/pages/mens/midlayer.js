            ...
            <div className="home__container">
                <div className="home__row">
                    ...
                    <div className="home__image-area">
                        <img src="/men/mid_layer/apollo_main_min.jpg" alt="main woman" className="home-image"/>
                    </div>
                </div>

                <div className="home__row">
                    <div className="home__image-area">
                        <img src="/men/mid_layer/explore_main_min.jpg" alt="main woman" className="home-image"/>
                    </div>
